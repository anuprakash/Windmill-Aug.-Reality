		...
		if (Input.GetMouseButtonDown (0)) {
			...
			if (Physics.Raycast (ray, out hit)) {
				if(hit.transform.CompareTag("Land")){
					...
					GameObject obj = Instantiate (GameObject.FindWithTag ("landmill")) as GameObject;
